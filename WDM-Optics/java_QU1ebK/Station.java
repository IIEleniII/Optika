...
public class Station {
	...
	CD cd = new CD(); //Collision Detection
...
//}
  ...
  public void AL_index(){ //ArrayList of packets duration
    cd.outDuration();}

	


 public void AL_packets(){ //ArrayList of actual packets
